...
Write a function that takes in number *numComputers* and an array of _cables_ that connect the
computers. Computers have ids from 0 to *numComputers - 1*. The function should return a cable that can be safely removed. There will be multiple
