...
Write a function, _tokenReplace_, that takes in an object of tokens and a string. The function
...
except to enclose a token. Tokens should be replaced from left to right in the string (see test_05).
